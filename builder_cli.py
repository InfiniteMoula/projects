...
STEP_REGISTRY = {
    ...
    "enrich.domain_guess": "enrich.domain_guess:run",
    "enrich.phone_site": "enrich.phone_site:run",
...
STEP_DEPENDENCIES = {
    ...
    "enrich.phone_site": {"normalize.standardize"},
    "enrich.domain_guess": {"normalize.standardize"},
